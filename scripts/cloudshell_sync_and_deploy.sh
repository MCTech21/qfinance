...
remote_payload="WEB_URL='${WEB_URL}' ENABLE_SWAP='${ENABLE_SWAP}' MIN_FREE_MB='${MIN_FREE_MB}' BRANCH='${BRANCH}' EC2_WORK_DIR='${EC2_WORK_DIR}' REPO_URL='${REPO_URL}' RESTART_BACKEND='${RESTART_BACKEND}' BACKEND_SERVICE_CANDIDATES='${BACKEND_SERVICE_CANDIDATES}' BACKEND_RESTART_COMMAND='${BACKEND_RESTART_COMMAND}' BACKEND_VERIFY_PATH='${BACKEND_VERIFY_PATH}' bash '${EC2_WORK_DIR}/scripts/ec2_sync_and_deploy.sh'"
